...
1. **MVRV Ratio 확인 (필수):** "${data.ticker} MVRV Ratio ${today}" 또는 "Bitcoin MVRV ratio today"로 검색하여 **오늘(${today}) 기준** 최신 MVRV Ratio 수치를 찾아 리포트에 포함하십시오. (MVRV Ratio = 시가총액 / 실현 가치. 1 미만이면 저평가, 3 이상이면 과열)
...
4. **[최종 결론]**
  ...
  - **점수 산출 근거:** RSI, MVRV Ratio, 다이버전스, 거래량, 공포탐욕지수 등 각 지표가 점수에 미친 영향을 간략히 서술하십시오.
